...
<div class="container5">
        ...
        <form id="loginForm" style="margin-top: 50px;">
            ...
            <div class="row">
                ...
                <div class="phone-input">
                    <select id="countryCode" name="countryCode">
                        ...
                        <option value="+355">+353 (Ireland)</option>
                        ...
                        <option value="+256">+356 (Malta)</option>
            ...
            <div class="row">
                <div class="column">
                    <label for="query">Any Questions?</label>
                    <textarea id="query" placeholder="Write your question here" rows="3"></textarea>
                </div>
            </div>  
            <div class="button2">
    ...
    <div id="popup" class="popup" style="padding-left: 500px;">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            form.addEventListener("submit", function (event) {
                ...
                if (firstName === "" || lastName === "" || email === "" || contact === "" || countryCode === "") {
                
                    popupMessage.textContent = "Please fill up the form first";
                    popupIcon.innerHTML = '<i class="fas fa-exclamation-circle"></i>';
                    popup.style.backgroundColor = "#FF6B6B";
                } else {
                
                    popupMessage.textContent = "Thank you for filling up the form";
                    popupIcon.innerHTML = '<i class="fas fa-check-circle"></i>';
                    popup.style.backgroundColor = "#6DBE45"; 
                    form.reset(); 
                }
